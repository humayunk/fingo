...
steps_pf101 = Step.create!([
  { lesson: lessons[0],
    ...
    category: :tutorial, order: 1 , image_name: "introduction_to_personal_finance.jpg" },
  { lesson: lessons[0],
    content: "Why is personal finance important?",
    category: :choice, order: 2 },
  { lesson: lessons[0],
    ...
    category: :tutorial, order: 3, image_name: "basics.jpg" },
  ...
  { lesson: lessons[1],
    ...
    category: :tutorial, order: 3, image_name: "introduction_to_personal_finance.jpg" },
